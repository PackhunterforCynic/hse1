...
const projectsData = {
  ...
  'medtourin': {
    ...
    heroVideo: '/videos/medtourin/004.mp4',
    gallery: [
      { type: 'video', url: '/videos/medtourin/001.mp4', orientation: 'landscape' },
      { type: 'video', url: '/videos/medtourin/002.mp4', orientation: 'landscape' },
      { type: 'video', url: '/videos/medtourin/003.mp4', orientation: 'landscape' },
      { type: 'video', url: '/videos/medtourin/004.mp4', orientation: 'landscape' }
    ],
    btsImage: praiseImg,
    credits: {
      director: 'Praise',
  ...
  'popnosh': {
    ...
    deliverables: ['Commercial Photography', 'Promotional Video'],
    heroVideo: '/videos/Havilah Log 1.mp4',
    gallery: [
      { type: 'image', url: '/images/medtourin/image.avif', orientation: 'landscape' },
      { type: 'image', url: '/images/medtourin/image.avif', orientation: 'portrait' }
    ],
    btsImage: praiseImg,
    credits: {
      director: 'Praise',
