...
export default function Projects() {
  ...
  return (
    <div className="w-full min-h-screen pt-32 pb-24 px-4 md:px-8 xl:px-12 max-w-[1920px] mx-auto overflow-hidden">
      <SEO 
            ...
            <GsapScrollReveal mode="image" delay={(index % 2) * 0.15} className="w-full rounded-2xl overflow-hidden shadow-2xl bg-white/5 backdrop-blur-md">
              <Link to={`/projects/${project.id}`} className="group block relative overflow-hidden aspect-[4/3]">
                <img 
                  ...
                  alt={project.title}
                  loading="lazy"
                  className="w-full h-full object-cover filter brightness-[0.8] group-hover:brightness-105 group-hover:scale-105 transition-all duration-700"
                />
