      ...
      {isOpen && member && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-5xl bg-white/5 backdrop-blur-md border border-white/10 rounded-sm overflow-hidden flex flex-col md:flex-row h-[80vh] md:h-[600px]"
          >
            {/* Close Button Mobile */}
            <button 
            ...
            <div className="w-full h-1/2 md:h-full md:w-1/2 p-8 md:p-12 flex flex-col overflow-y-auto">
              ...
              <div className="flex-grow">
                <p className="text-base md:text-lg font-sans font-light leading-relaxed text-white/80 mb-8">
                  {member.fullBio}
                </p>
                
                <div className="mb-8">
                  <h4 className="text-xs font-mono tracking-widest uppercase text-white/50 mb-4">Expertise</h4>
              ...
              <div className="flex gap-6 border-t border-white/10 pt-6 mt-auto">
                {member.socials.map((link, idx) => (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="text-xs font-mono uppercase tracking-widest text-white/60 hover:text-accent transition-colors cursor-none"
