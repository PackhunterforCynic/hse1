          ...
          <div className="w-full max-w-4xl mx-auto flex flex-col h-[80vh]">
            ...
            <div className="relative mb-8">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 focus:border-white/30 rounded-2xl py-6 pl-20 pr-16 md:pr-40 text-xl md:text-3xl font-display text-white placeholder-white/30 outline-none transition-all"
              />
