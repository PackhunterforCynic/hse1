      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
        ...
        <div className="lg:col-span-8 flex flex-col gap-24">
          {narrativeSections.map((section, idx) => (
            ...
            >
              <h3 className="text-3xl md:text-5xl font-display uppercase tracking-widest text-white mb-8">
                {section.title}
              </h3>
              <p className="text-xl md:text-2xl font-light font-serif italic text-white/70 leading-relaxed max-w-3xl">
                {section.content}
              </p>
            </motion.div>
          ))}
