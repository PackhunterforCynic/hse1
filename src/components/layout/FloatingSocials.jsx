  ...
  return (
    <motion.div
      ...
      className="fixed z-50 flex items-center justify-center 
                 bottom-6 left-1/2 -translate-x-1/2 flex-row gap-6 bg-white/5 backdrop-blur-md/50 backdrop-blur-md px-8 py-4 rounded-full border border-white/5
    ...
    >
      {socials.map((social) => (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`text-white/50 ${social.theme || 'hover:text-accent'} transition-colors duration-300 hover:scale-110 transform cursor-none`}
